...
var common = __importStar(require("./external/transforms-common"));
var helpers_1 = require("./helpers");
var printer = ts.createPrinter({ newLine: ts.NewLineKind.LineFeed });
function parse(parsingNode, sourceFile) {
    ...
    function parseCommonNode(node) {
        ...
        return common_1.throwError("Unhandled node kind (" + node.kind + ") in text: " + getNodeText(node) + " (Please open an issue if you believe this should be supported.)");
    }
